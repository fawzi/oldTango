...
Object *_d_translate_se_to_d_exception(PCONTEXT context,EXCEPTION_RECORD *exception_record)
{
    ...
    switch (exception_record->ExceptionCode) {
        ...
        case STATUS_DATATYPE_MISALIGNMENT:
            pti = _d_create_exception_object(context,&_Class_9Exception, "Datatype Misalignment");
            break;

        case STATUS_ARRAY_BOUNDS_EXCEEDED:
            pti = _d_create_exception_object(context,&_Class_9Exception, "Array Bounds Exceeded");
            break;
