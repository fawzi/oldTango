    ...
    char[] toString(){
        ...
        for (size_t i=0;i<dim;++i){
            for (int idim=internal_t.sizeof;idim!=0;){
                --idim;
                ubyte v=cast(ubyte)(0xFF & (p[i]>>8*idim));
                ubyte v0=v & 0xF;
                v>>=4;
...
debug( UnitTest2 )
{
  unittest
  {
    BitVector!(5) d = [cast(bool)1,0,1,1,1];
    BitVector!(5) e = [cast(bool)1,0,1,0,1];
...
debug( UnitTest2 )
{
  unittest
  {
    BitVector!(5) a = [cast(bool)1,0,1,0,1];
    BitVector!(5) d = [cast(bool)1,0,1,1,1];
    BitVector!(5) e = [cast(bool)1,0,1,0,1];
